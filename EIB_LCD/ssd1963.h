...
#define SSD1963_50_X_OFFSET			220 //3900
#define SSD1963_50_X_OFFSET_FACT	4.6	//4.7
...
// Prototypes
void ssd1963_controller_init(uint8_t lcd_type, uint8_t rotate, volatile uint16_t *, volatile uint16_t *);
